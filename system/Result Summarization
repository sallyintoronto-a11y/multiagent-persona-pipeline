...
# ---- CONFIG ----
OUT_DIR = "/content/outputs"     # Root directory created by run_batch
ROUND_DIGITS = 3
...
master_json_path = os.path.join(summary_dir, "summary_master.json")
with open(master_json_path, "w", encoding="utf-8") as f:
    json.dump(master, f, ensure_ascii=False, indent=2)

flat_json_path = os.path.join(summary_dir, "summary_pairs.json")
